"""
Mastermind Sidecar — spacex-satellite-mesh
...
class MastermindSidecar:
    ...
    def __init__(self, repo_name: str = "spacex-satellite-mesh"):
        self.repo_name = repo_name
        self.start_time = time.time()
        self.health_cache: Dict[str, Any] = {}
        self._modules = [mesh_routing, constellation_manager, temporal_routing]
